#!/usr/bin/env python3
"""Gate for VERIFY.SCALE.STOREFRONT_LISTING_P95.01."""
...
def main() -> int:
    ...
    gates = {
        ...
        "category_listing_p95_within_threshold": p95_ms <= P95_THRESHOLD_MS,
    }
    metrics = {
    ...
    ok = all(gates.values())
    report = {
        "claim_id": "VERIFY.SCALE.STOREFRONT_LISTING_P95.01",
    ...
    print(f"VERIFY.SCALE.STOREFRONT_LISTING_P95.01: {'PASS' if ok else 'FAIL'}")
