#!/usr/bin/env python3
"""Gate for VERIFY.SCALE.ADMIN_SEARCH_CRITERIA_TRIM.01."""
...
def main() -> int:
    ...
    gates = {
        ...
        "admin_search_p95_trimmed": p95_ms <= P95_THRESHOLD_MS,
    }
    metrics = {
        "p95_ms": p95_ms,
        "p50_ms": bench.get("p50_ms"),
        "wave2_baseline_ms": WAVE2_BASELINE_MS,
        "delta_ms": round(p95_ms - WAVE2_BASELINE_MS, 2),
    ...
    ok = all(gates.values())
    report = {
        "claim_id": "VERIFY.SCALE.ADMIN_SEARCH_CRITERIA_TRIM.01",
    ...
    print(f"VERIFY.SCALE.ADMIN_SEARCH_CRITERIA_TRIM.01: {'PASS' if ok else 'FAIL'}")
