#!/usr/bin/env python3
"""Gate for VERIFY.REQ.HOME_LISTING_WIDGET_UX.05."""
...
WIDGET_P95_THRESHOLD_MS = 3000.0
MIN_PRODUCTS = 20
WARMUP = 2
ITERATIONS = 10
...
def main() -> int:
    ...
    nav_id = extract_navigation_id(home_html)
    if not nav_id:
        nav_id = ""
    ...
    ok = all(gates.values())
    report = {
        "claim_id": "VERIFY.REQ.HOME_LISTING_WIDGET_UX.05",
    ...
    print(f"VERIFY.REQ.HOME_LISTING_WIDGET_UX.05: {'PASS' if ok else 'FAIL'}")
