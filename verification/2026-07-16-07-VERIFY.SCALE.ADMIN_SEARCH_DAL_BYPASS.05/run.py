#!/usr/bin/env python3
"""Gate for VERIFY.SCALE.ADMIN_SEARCH_DAL_BYPASS.05."""
...
def main() -> int:
    ...
    gates = {
        ...
        "admin_search_p95_dal_bypass": p95_ms <= P95_THRESHOLD_MS,
    ...
    ok = all(gates.values())
    report = {
        "claim_id": "VERIFY.SCALE.ADMIN_SEARCH_DAL_BYPASS.05",
    ...
    print(f"VERIFY.SCALE.ADMIN_SEARCH_DAL_BYPASS.05: {'PASS' if ok else 'FAIL'}")
