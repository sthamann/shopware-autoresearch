#!/usr/bin/env python3
"""Gate for VERIFY.SCALE.TRUE_LISTING_CMS_DEFER.05."""
...
def main() -> int:
    ...
    gates = {
        ...
        "true_listing_cms_deferred_p95": p95_ms <= P95_THRESHOLD_MS,
        "improved_vs_wave4": p95_ms < WAVE4_BASELINE_MS,
    }
    metrics = {
        "p95_ms": round(p95_ms, 2),
        "p50_ms": round(p50_ms, 2),
        "wave4_baseline_ms": WAVE4_BASELINE_MS,
        "delta_ms": round(p95_ms - WAVE4_BASELINE_MS, 2),
    ...
    ok = all(gates.values())
    report = {
        "claim_id": "VERIFY.SCALE.TRUE_LISTING_CMS_DEFER.05",
    ...
    print(f"VERIFY.SCALE.TRUE_LISTING_CMS_DEFER.05: {'PASS' if ok else 'FAIL'}")
